...
incoming_link = ['1','-3','4','-6','7','-9','10','-12']
outcoming_link = ['-1','3','-4','6','-7','9','-10','12']
demand_per_od = 80
...
#500veh/lane/h
# demand_per_od[0] = 1000
# demand_per_od[1] = 2000
# demand_per_od[2] = 2000
...
#duarouter --route-files=trip.trip.xml --net-file=2x2.net.xml --output-file=Demand_20.rou.xml --randomize-flows true --departspeed 10 --weights.random-factor 1.5 --seed 30
